...
贴在屏幕边缘的离线 Windows 待办工具。

[下载 Windows x64 版](https://github.com/lat1bulate/SideLine/releases/latest)

当前软件界面为中文，英文 README 不代表已提供英文界面。下载 ZIP 后解压运行 Sideline.exe；需要 WebView2 Runtime，待办数据保存在应用数据目录而非 EXE 所在目录。
